...
using ProjekatAspNikolaRiorovic.Application.Core;
...
namespace ProjekatAspNikolaRiorovic.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ProjekatAspNikolaRiorovicContext>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ProjekatAspNikolaRiorovic", Version = "v1" });
